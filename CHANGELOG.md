...
- [#2346](https://github.com/livepeer/go-livepeer/pull/2346) Fix syntax errors in example JSON
...
- [#2357](https://github.com/livepeer/go-livepeer/pull/2357) Begin accepting auth header (from Mist) and have it override callback URL values
- [#2385](https://github.com/livepeer/go-livepeer/pull/2385) Change verification randomness variable meaning
