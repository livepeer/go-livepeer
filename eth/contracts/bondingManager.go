...
//
// Solidity: function getTranscoder(_transcoder address) constant returns(lastRewardRound uint256, blockRewardCut uint8, feeShare uint8, pricePerSegment uint256, pendingBlockRewardCut uint8, pendingFeeShare uint8, pendingPricePerSegment uint256)
