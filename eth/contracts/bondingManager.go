...
// TranscoderToRewardCaller is a free data retrieval call binding the contract method 0x47621410.
//
// Solidity: function transcoderToRewardCaller(address ) view returns(address)
func (_BondingManager *BondingManagerCaller) TranscoderToRewardCaller(opts *bind.CallOpts, arg0 common.Address) (common.Address, error) {
	var out []interface{}
	err := _BondingManager.contract.Call(opts, &out, "transcoderToRewardCaller", arg0)
...
//
// Solidity: function transcoderToRewardCaller(address ) view returns(address)
func (_BondingManager *BondingManagerSession) TranscoderToRewardCaller(arg0 common.Address) (common.Address, error) {
	return _BondingManager.Contract.TranscoderToRewardCaller(&_BondingManager.CallOpts, arg0)
}

// TranscoderToRewardCaller is a free data retrieval call binding the contract method 0x47621410.
//
// Solidity: function transcoderToRewardCaller(address ) view returns(address)
func (_BondingManager *BondingManagerCallerSession) TranscoderToRewardCaller(arg0 common.Address) (common.Address, error) {
	return _BondingManager.Contract.TranscoderToRewardCaller(&_BondingManager.CallOpts, arg0)
}
...
// RewardForTranscoder is a paid mutator transaction binding the contract method 0x1a8c41f8.
//
// Solidity: function rewardForTranscoder(address _transcoder) returns()
func (_BondingManager *BondingManagerTransactor) RewardForTranscoder(opts *bind.TransactOpts, _transcoder common.Address) (*types.Transaction, error) {
	return _BondingManager.contract.Transact(opts, "rewardForTranscoder", _transcoder)
}

// RewardForTranscoder is a paid mutator transaction binding the contract method 0x1a8c41f8.
//
// Solidity: function rewardForTranscoder(address _transcoder) returns()
func (_BondingManager *BondingManagerSession) RewardForTranscoder(_transcoder common.Address) (*types.Transaction, error) {
	return _BondingManager.Contract.RewardForTranscoder(&_BondingManager.TransactOpts, _transcoder)
}

// RewardForTranscoder is a paid mutator transaction binding the contract method 0x1a8c41f8.
//
// Solidity: function rewardForTranscoder(address _transcoder) returns()
func (_BondingManager *BondingManagerTransactorSession) RewardForTranscoder(_transcoder common.Address) (*types.Transaction, error) {
	return _BondingManager.Contract.RewardForTranscoder(&_BondingManager.TransactOpts, _transcoder)
}

// RewardForTranscoderWithHint is a paid mutator transaction binding the contract method 0xb556966a.
//
// Solidity: function rewardForTranscoderWithHint(address _transcoder, address _newPosPrev, address _newPosNext) returns()
func (_BondingManager *BondingManagerTransactor) RewardForTranscoderWithHint(opts *bind.TransactOpts, _transcoder common.Address, _newPosPrev common.Address, _newPosNext common.Address) (*types.Transaction, error) {
	return _BondingManager.contract.Transact(opts, "rewardForTranscoderWithHint", _transcoder, _newPosPrev, _newPosNext)
}

// RewardForTranscoderWithHint is a paid mutator transaction binding the contract method 0xb556966a.
//
// Solidity: function rewardForTranscoderWithHint(address _transcoder, address _newPosPrev, address _newPosNext) returns()
func (_BondingManager *BondingManagerSession) RewardForTranscoderWithHint(_transcoder common.Address, _newPosPrev common.Address, _newPosNext common.Address) (*types.Transaction, error) {
	return _BondingManager.Contract.RewardForTranscoderWithHint(&_BondingManager.TransactOpts, _transcoder, _newPosPrev, _newPosNext)
}

// RewardForTranscoderWithHint is a paid mutator transaction binding the contract method 0xb556966a.
//
// Solidity: function rewardForTranscoderWithHint(address _transcoder, address _newPosPrev, address _newPosNext) returns()
func (_BondingManager *BondingManagerTransactorSession) RewardForTranscoderWithHint(_transcoder common.Address, _newPosPrev common.Address, _newPosNext common.Address) (*types.Transaction, error) {
	return _BondingManager.Contract.RewardForTranscoderWithHint(&_BondingManager.TransactOpts, _transcoder, _newPosPrev, _newPosNext)
}
...
// SetRewardCaller is a paid mutator transaction binding the contract method 0x0103e60e.
//
// Solidity: function setRewardCaller(address _rewardCaller) returns()
func (_BondingManager *BondingManagerTransactor) SetRewardCaller(opts *bind.TransactOpts, _rewardCaller common.Address) (*types.Transaction, error) {
	return _BondingManager.contract.Transact(opts, "setRewardCaller", _rewardCaller)
}

// SetRewardCaller is a paid mutator transaction binding the contract method 0x0103e60e.
//
// Solidity: function setRewardCaller(address _rewardCaller) returns()
func (_BondingManager *BondingManagerSession) SetRewardCaller(_rewardCaller common.Address) (*types.Transaction, error) {
	return _BondingManager.Contract.SetRewardCaller(&_BondingManager.TransactOpts, _rewardCaller)
}

// SetRewardCaller is a paid mutator transaction binding the contract method 0x0103e60e.
//
// Solidity: function setRewardCaller(address _rewardCaller) returns()
func (_BondingManager *BondingManagerTransactorSession) SetRewardCaller(_rewardCaller common.Address) (*types.Transaction, error) {
	return _BondingManager.Contract.SetRewardCaller(&_BondingManager.TransactOpts, _rewardCaller)
}
...
// BondingManagerRewardCallerSetIterator is returned from FilterRewardCallerSet and is used to iterate over the raw logs and unpacked data for RewardCallerSet events raised by the BondingManager contract.
type BondingManagerRewardCallerSetIterator struct {
	Event *BondingManagerRewardCallerSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BondingManagerRewardCallerSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BondingManagerRewardCallerSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BondingManagerRewardCallerSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BondingManagerRewardCallerSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BondingManagerRewardCallerSet represents a RewardCallerSet event raised by the BondingManager contract.
type BondingManagerRewardCallerSet struct {
	Transcoder   common.Address
	RewardCaller common.Address
	Raw          types.Log // Blockchain specific contextual infos
}

// FilterRewardCallerSet is a free log retrieval operation binding the contract event 0x15932b87747cac36d3c505e86a946c6d3a79d9d7bdb79d81584d32bbe54516c2.
//
// Solidity: event RewardCallerSet(address indexed transcoder, address indexed rewardCaller)
func (_BondingManager *BondingManagerFilterer) FilterRewardCallerSet(opts *bind.FilterOpts, transcoder []common.Address, rewardCaller []common.Address) (*BondingManagerRewardCallerSetIterator, error) {

	var transcoderRule []interface{}
	for _, transcoderItem := range transcoder {
		transcoderRule = append(transcoderRule, transcoderItem)
	}
	var rewardCallerRule []interface{}
	for _, rewardCallerItem := range rewardCaller {
		rewardCallerRule = append(rewardCallerRule, rewardCallerItem)
	}

	logs, sub, err := _BondingManager.contract.FilterLogs(opts, "RewardCallerSet", transcoderRule, rewardCallerRule)
	if err != nil {
		return nil, err
	}
	return &BondingManagerRewardCallerSetIterator{contract: _BondingManager.contract, event: "RewardCallerSet", logs: logs, sub: sub}, nil
}

// WatchRewardCallerSet is a free log subscription operation binding the contract event 0x15932b87747cac36d3c505e86a946c6d3a79d9d7bdb79d81584d32bbe54516c2.
//
// Solidity: event RewardCallerSet(address indexed transcoder, address indexed rewardCaller)
func (_BondingManager *BondingManagerFilterer) WatchRewardCallerSet(opts *bind.WatchOpts, sink chan<- *BondingManagerRewardCallerSet, transcoder []common.Address, rewardCaller []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _BondingManager.contract.WatchLogs(opts, "RewardCallerSet", transcoderRule, rewardCallerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BondingManagerRewardCallerSet)
				if err := _BondingManager.contract.UnpackLog(event, "RewardCallerSet", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseRewardCallerSet is a log parse operation binding the contract event 0x15932b87747cac36d3c505e86a946c6d3a79d9d7bdb79d81584d32bbe54516c2.
//
// Solidity: event RewardCallerSet(address indexed transcoder, address indexed rewardCaller)
func (_BondingManager *BondingManagerFilterer) ParseRewardCallerSet(log types.Log) (*BondingManagerRewardCallerSet, error) {
	event := new(BondingManagerRewardCallerSet)
	if err := _BondingManager.contract.UnpackLog(event, "RewardCallerSet", log); err != nil {
		return nil, err
	}
