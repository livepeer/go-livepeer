INSERT INTO public.users (
    id, name, email, created_at, last_login, is_active, provider, additional_details
) VALUES (
...
INSERT INTO public.pipelines (
    id, created_at, updated_at, last_used, name, description, is_private, cover_image,
    type, sample_code_repo, is_featured, sample_input_video, author, model_card, key,
    config, comfy_ui_json, version, validation_status, prioritized_params
) VALUES (
                     ...
                     "primary": {
                         ...
                         "defaultValue": {
                             ...
                             "2": {
                                 ...
                                 "inputs": { "engine": "depth_anything_vitl14-fp16.engine", "images": ["1", 0] },
                             ...
                             "24": {
                                 "_meta": { "title": "Feature Bank Attention Processor" },
                                 "inputs": {
                                     "model": ["3", 0],
