...
func (c *aIWorkerClient) RegisterAIWorker(ctx context.Context, in *RegisterAIWorkerRequest, opts ...grpc.CallOption) (AIWorker_RegisterAIWorkerClient, error) {
	stream, err := c.cc.NewStream(ctx, &AIWorker_ServiceDesc.Streams[0], "/net.AIWorker/RegisterAIWorker", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *aIWorkerRegisterAIWorkerClient) Recv() (*NotifyAIWork, error) {
	m := new(NotifyAIWork)
...
func (x *aIWorkerRegisterAIWorkerServer) Send(m *NotifyAIWork) error {
