...
const (
	...
	AIRequestType_ImageToImage AIRequestType = 1
	AIRequestType_ImageToVideo AIRequestType = 2
...
var file_net_lp_rpc_proto_rawDesc = []byte{
	...
	0x2a, 0x51, 0x0a, 0x0d, 0x41, 0x49, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x0f, 0x0a, 0x0b, 0x54, 0x65, 0x78, 0x74, 0x54, 0x6f, 0x49, 0x6d, 0x61, 0x67, 0x65,
	0x10, 0x00, 0x12, 0x10, 0x0a, 0x0c, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x49, 0x6d, 0x61,
	0x67, 0x65, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x56,
	0x69, 0x64, 0x65, 0x6f, 0x10, 0x02, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x70, 0x73, 0x63, 0x61, 0x6c,
	0x65, 0x10, 0x03, 0x32, 0xd8, 0x01, 0x0a, 0x0c, 0x4f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72,
	...
	0x0d, 0x2e, 0x6e, 0x65, 0x74, 0x2e, 0x50, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x6e, 0x67, 0x32, 0x8c,
	0x01, 0x0a, 0x0a, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x12, 0x40, 0x0a,
	...
	0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x30, 0x01, 0x12,
	0x3c, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x41, 0x49, 0x57, 0x6f, 0x72,
	0x6b, 0x65, 0x72, 0x12, 0x14, 0x2e, 0x6e, 0x65, 0x74, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x6e, 0x65, 0x74, 0x2e,
	0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x41, 0x49, 0x4a, 0x6f, 0x62, 0x30, 0x01, 0x42, 0x07, 0x5a,
	0x05, 0x2e, 0x2f, 0x6e, 0x65, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_net_lp_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_net_lp_rpc_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*OSInfo); i {
			case 0:
				return &v.state
			case 1:
		...
		file_net_lp_rpc_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[16].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[17].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[18].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[20].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[21].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[22].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[24].Exporter = func(v any, i int) any {
		...
		file_net_lp_rpc_proto_msgTypes[26].Exporter = func(v any, i int) any {
