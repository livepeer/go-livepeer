...
type VideoProfile struct {
	...
	// FPS of VideoProfile
	Fps                  int32    `protobuf:"varint,20,opt,name=fps,proto3" json:"fps,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *VideoProfile) GetFps() int32 {
	if m != nil {
		return m.Fps
	}
	return 0
...
var fileDescriptor_034e29c79f9ba827 = []byte{
	...
	0x10, 0x0e, 0x2d, 0x59, 0xb6, 0x46, 0x92, 0x23, 0x6f, 0x1c, 0x87, 0x71, 0xdb, 0xc0, 0x21, 0x12,
	0xc0, 0x3d, 0xc4, 0x2d, 0x6c, 0x24, 0x40, 0x6e, 0x4d, 0x1a, 0x23, 0x16, 0x50, 0xc4, 0xc2, 0xca,
	...
	,
}
