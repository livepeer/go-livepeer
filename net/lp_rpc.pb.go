...
type OrchestratorInfo struct {
	...
	// List of other instance URIs belonging to this orchestrator.
	Instances     []string `protobuf:"bytes,34,rep,name=instances,proto3" json:"instances,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OrchestratorInfo) GetInstances() []string {
	if x != nil {
		return x.Instances
	}
	return nil
...
const file_net_lp_rpc_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v27.net.Capabilities.CapabilityConstraints.ModelConstraintR\x05value:\x028\x01\"\xd5\x03\n" +
	...
	"\x13capabilities_prices\x18! \x03(\v2\x0e.net.PriceInfoR\x12capabilitiesPrices\x12\x1c\n" +
	"\tinstances\x18\" \x03(\tR\tinstances\"`\n" +
	"\tAuthToken\x12\x14\n" +
