...
type Fraction struct {
	...
	Denom                uint32   `protobuf:"varint,2,opt,name=denom,proto3" json:"denom,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Fraction) GetDenom() uint32 {
	if m != nil {
		return m.Denom
	}
	return 0
...
type SceneClassificationData struct {
	...
	ClassProbs           map[uint32]*Fraction `protobuf:"bytes,1,rep,name=class_probs,json=classProbs,proto3" json:"class_probs,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *SceneClassificationData) GetClassProbs() map[uint32]*Fraction {
	if m != nil {
		return m.ClassProbs
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Fraction)(nil), "net.Fraction")
	proto.RegisterType((*SceneClassificationData)(nil), "net.SceneClassificationData")
	proto.RegisterMapType((map[uint32]*Fraction)(nil), "net.SceneClassificationData.ClassProbsEntry")
...
var fileDescriptor_034e29c79f9ba827 = []byte{
	...
	,
}
