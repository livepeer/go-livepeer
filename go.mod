...
require (
	...
	github.com/livepeer/ai-worker v0.0.0-20240220213200-59b5b237cd8b
...
replace github.com/livepeer/ai-worker => github.com/livepeer/ai-worker v0.0.0-20240415144158-bff8c02dae2a
