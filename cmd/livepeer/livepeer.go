...
func parseLivepeerConfig() starter.LivepeerConfig {
	...
	cfg.DiscoveryTimeout = flag.Int("discoveryTimeout", *cfg.DiscoveryTimeout, "Time in milliseconds to wait for first round of GetOrchestrator responses (default = 500ms)")
