...
func main() {
	...
	minGasPrice := flag.Int64("minGasPrice", 0, "Minimum gas price (priority fee + base fee) for Arbitrum-ETH transactions in ArbGas")
	maxGasPrice := flag.Int("maxGasPrice", 0, "Maximum gas price (priority fee + base fee) for Arbirtrum-ETH transactions in ArbGas")
