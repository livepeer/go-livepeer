...
func main() {
	...
	bootIDs := flag.String("bootIDs", "12203efa6d7276eb95be161138920a7d7be970bf5fdcdf5fb320fca81728ea95dce4", "Comma-separated bootstrap node IDs")
	bootAddrs := flag.String("bootAddrs", "/ip4/18.221.2.81/tcp/15000", "Comma-separated bootstrap node addresses")
