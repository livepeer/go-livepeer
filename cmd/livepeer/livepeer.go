...
func parseLivepeerConfig() starter.LivepeerConfig {
	...
	cfg.SelectPriceExpFactorA = flag.Float64("selectPriceExpFactorA", *cfg.SelectPriceExpFactorA, "Expresses how significant a small change of price is for the selection algorithm; default 0.001")
	cfg.SelectPriceExpFactorB = flag.Float64("selectPriceExpFactorB", *cfg.SelectPriceExpFactorB, "Expresses how significant a small change of price is for the selection algorithm; default 20")
	cfg.SelectPriceCenter = flag.Float64("selectPriceCenter", *cfg.SelectPriceCenter, "Centers the price weighted selection curve around this number, giving increasingly diminishing returns starting at that price point; default 150")
