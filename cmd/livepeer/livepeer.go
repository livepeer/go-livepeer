...
func parseLivepeerConfig() starter.LivepeerConfig {
	...
	cfg.LiveOutSegmentTimeout = flag.Duration("liveOutSegmentTimeout", *cfg.LiveOutSegmentTimeout, "Timeout for waiting for the output segment to be available in the Live AI pipeline before swapping an Orchestrator; default to no timeout")
