...
func NewLivepeerConfig(fs *flag.FlagSet) LivepeerConfig {
	...
	cfg.AdditionalInstances = fs.Int("additionalInstances", *cfg.AdditionalInstances, "Number of additional instances an orchestrator can advertise within GetOrchestratorInfo response")
