...
func (r *stubOrchestrator) ProcessPayment(payment net.Payment, segData *core.SegTranscodingMetadata) error {
	return nil
}
...
func (o *mockOrchestrator) ProcessPayment(payment net.Payment, segData *core.SegTranscodingMetadata) error {
	args := o.Called(payment, segData)
	return args.Error(0)
}
