...
func (r *stubOrchestrator) LiveVideoToVideo(ctx context.Context, requestID, gatewayRequestID, streamID string, req worker.GenLiveVideoToVideoJSONRequestBody) (interface{}, error) {
	return nil, nil
}
...
func (r *mockOrchestrator) LiveVideoToVideo(ctx context.Context, requestID, gatewayRequestID, streamID string, req worker.GenLiveVideoToVideoJSONRequestBody) (interface{}, error) {
	return nil, nil
}
