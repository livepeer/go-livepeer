...
all: net/lp_rpc.pb.go net/redeemer.pb.go net/redeemer_mock.pb.go core/test_segment.go livepeer livepeer_cli livepeer_router livepeer_bench livepeer_cap
...
.PHONY: livepeer_cap
livepeer_cap:
	GO111MODULE=on CGO_LDFLAGS="$(cgo_ldflags)" go build -o livepeer_cap -ldflags="$(ldflags)" cmd/livepeer_cap/*.go
