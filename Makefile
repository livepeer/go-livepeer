...
export PRODUCT_RELEASE=$(shell ./print_version.sh)

ldflags := -X github.com/livepeer/go-livepeer/core.LivepeerVersion=$(PRODUCT_RELEASE) -X main.ProductRelease=$(PRODUCT_RELEASE)
